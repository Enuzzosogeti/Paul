...
*/
%Macro ScenarioA(key,weight,HMID,scenario);
...
/*****************************************************************************************/
data dtemp_&Country_imported. (keep= &key. &weight.);
set &Country_imported._AfterRecodings;
where &HMID. = "1";
run;
...
data test10_scA (rename=(cinq_puissance_moins_quatre = '0.0005'n  un_puissance_moins_trois = '0.001'n  cinq_puissance_moins_trois = '0.005'n  un_puissance_moins_deux = '0.01'n  cinq_puissance_moins_deux = '0.05'n)
...
proc export data=test10_scA 
            outfile="&path_scenarios_ST./&Country_imported._at_risk_scenario_A1.txt"
            dbms = tab replace;
            delimiter = "  ";
putnames = yes;
run;
...
/***************************************************/
/* suppression des dernieres tables intermediaires */
/***************************************************/
proc datasets lib=work nolist;
...
%ScenarioA (key = NUTS1 HA09 MB02 age5 MB05,
            weight = HA10,
			HMID = MB05,scenario = "SC. A1:");