...
*/
%Macro ScenarioC(key,weight,HMID,scenario);
...
data test10_scC (rename=(cinq_puissance_moins_quatre = '0.0005'n  un_puissance_moins_trois = '0.001'n  cinq_puissance_moins_trois = '0.005'n  un_puissance_moins_deux = '0.01'n  cinq_puissance_moins_deux = '0.05'n)
...
%ScenarioC (key = NUTS1 HA09 MB02 age5 ME04 ME0908,
            weight = HA10,
			HMID = MB05, scenario = "SC. C1:");